...
public class LoggingAspect {
    ...
    @Pointcut(
            "within(com.lomari.clustereddatawarehouse.repository..*)" +
                    " || within(com.lomari.clustereddatawarehouse.service..*)" +
                    " || within(com.lomari.clustereddatawarehouse.controller..*)"
    )
